---
name: msds-translator-shenyang
description: Translates Chinese MSDS documents into professional English following the SUN-NOA standardized 16-section GHS MSDS template (Shenyang SUN-NOA office header). Use when the user provides a Chinese MSDS (Word, PDF, or text) and asks for an English translation formatted according to the company's standard MSDS template.
---
...
- The only company names that may appear are:
  - English: Shenyang SUN-NOA Technology Development Co., Ltd.
  - Chinese: 沈阳圣诺亚科技发展有限公司
