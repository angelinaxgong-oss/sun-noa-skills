...
5. Other Notes / 其他说明 — catch-all for usage instructions, safety, storage, etc.
6. Cleaning / 清洁
...
Extract these fields from the source. If a field is missing, mark [Not provided]:
| EN | CN |
|---|---|
| Appearance | 外观 |
...
## Application Techniques — FIXED fields (EVA)
Extract these fields from the source. If a field is missing, mark [Not provided]:
| EN | CN |
|---|---|
